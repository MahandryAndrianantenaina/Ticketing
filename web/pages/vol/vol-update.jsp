            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Modification vol</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Modification de vol</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical" method="post" action="update">
                                <div class="form-body">
                                    <div class="row">
                                        <input type="hidden" id="idvol" class="form-control"
                                                name="idvol" value="<%= vol.getIdvol()%>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select" id="avion" name="idavion">
                                                        ...
                                                        <% for(Avion avion : avions) { %>
                                                            <% if (avion.getIdavion() == vol.getIdavion()) { %>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select" id="ville" name="idville">
                                                        ...
                                                        <% for(Ville ville : villes) { %>
                                                            <% if (ville.getIdville()== vol.getIdville()) { %>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="datetime-local" id="depart-column" class="form-control"
                                                           name="depart" value="<%= vol.getDepart()%>">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="datetime-local" id="arrivee-column" class="form-control"
                                                            name="arrivee" value="<%= vol.getArrivee()%>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="prix" class="form-control"
                                                           name="prix" placeholder="Prix" value="<%= vol.getPrix()%>">
                                                </div>
                                            </div>
                                            <p></p>
